...
export const kubernetesDistributions: KubernetesDistribution[] = [
  {
    ...
    script: "wget https://raw.githubusercontent.com/GhanshyamRamole/k8s-Hub/main/minikube/minikube.sh  \n chmod +x minikube.sh \n ./minikube.sh "
  },
  {
    id: "eks",
    name: "eks",
    ...
    script: "wget https://raw.githubusercontent.com/GhanshyamRamole/k8s-Hub/main/eks/eks-cluster.sh \n chmod +x eks-cluster.sh \n ./eks-cluster.sh "
  },
  {
    id: "microk8s",
    name: "MicroK8s",
    ...
    script: "wget https://raw.githubusercontent.com/GhanshyamRamole/k8s-Hub/main/microk8s/microk8s.sh \n chmod +x microk8s.sh \n ./microk8s.sh "
  },
  {
    id: "kind",
    name: "KIND",
    ...
    script: "wget https://raw.githubusercontent.com/GhanshyamRamole/k8s-Hub/main/kind/kind-cluster.sh \n chmod +x kind-cluster.sh \n ./kind-cluster.sh"
  },
  {
    id: "k0s",
    name: "k0s",
